...
<html lang="en">
    ...
    <body class="sb-nav-fixed">
     ...
     <main>
                ...
                <div class="card mb-4">
                    <div class="card-body">
                        <div class="card-header text-danger"><h3 class="text-center font-weight-light my-4">Modifier des actualités</h3></div>
                        <div class="card-body">
                            <form action="" method="POST" enctype="multipart/form-data">
                                <input type="text" name="id" value="<?php if(isset($_POST['id'])){ echo $_POST['id'];} ?>" hidden>
                                <div class="form-floating mb-3">
                                    <input class="form-control" name="titre"  placeholder="Titre" value="<?php if(isset($titre)){ echo $titre; } ?>"/>
                                    <label for="description">Titre</label>
                                </div>
                                <div class="form-floating mb-3">
                                    <input class="form-control" name="description" placeholder="Description" required value="<?php if(isset($description)){ echo $description; } ?>"/>
                                    <label for="description">Description</label>
                                </div>
                                
                                <div class="form-floating mb-3">
                                    <input class="form-control" name="contenu" placeholder="Contenu" required value="<?php if(isset($contenu)){ echo $contenu; } ?>"/>
                               ...
                               <div> <span class="text-danger text-bolder-bold"><?php echo $erreur ; ?></span></div>
                                    <input class="btn btn-success" type="submit" name="submit1" value="Valider"/>
